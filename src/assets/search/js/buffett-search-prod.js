...
(function (window) {
    queryly = {
        QuerylyKey: '4cd6f71fbf22424d', //'152c5b6d27314088',
        urlQuery: '',
        instantSearch: false,
        searchtimer: null,
        searchredirect: '',
            ...
            try {
                ...
                for (var i = 0; i < results.results.length; i++) {
                        ...
                        if (typeof results.partners != 'undefined' && results.results[i]._index == 5 && results.partners.length > 0 && results.partners[0].results.length > 2) {
                            ...
                            for (var j = 0; j < results.partners[0].results.length ; j++) {
                                ...
                                if (typeof queryly.resultdata.duration != 'undefined') {
                                    ...
                                    var secs = Math.floor(queryly.resultdata.duration % 60);
                                    if (minutes != 0 || secs != 0) {
                                        if (secs < 10) {
                                            secs = "0" + secs;
                                        }
                                ...
                                if (queryly.resultdata['cn:title'].length > 55) {
                                    queryly.resultdata['cn:title'] = queryly.resultdata['cn:title'].substring(0, 55) + "...";
                                }
                                //queryly.resultdata['cn:title'] = queryly.resultdata['cn:title'].replace(/(([^\s]+\s\s*){8})(.*)/, "$1...");
                                ...
                                queryly.resultdata.authorurl = '';
                                queryly.resultdata.author = ''
                                try {
                    ...
                    if (typeof queryly.resultdata["cn:subtype"] != 'undefined' && queryly.resultdata["cn:subtype"].indexOf("full_length") >= 0) {
                        ...
                        if (typeof queryly.resultdata.section != 'undefined' && queryly.resultdata.section != '') {
                            queryly.resultdata.label = 'Clip  |  ' + queryly.resultdata.section;
                        }
                    }
                    ...
                    if (typeof queryly.resultdata.duration != 'undefined') {
                        var hours = Math.floor(queryly.resultdata.duration / 3600);
                        var minutes = Math.floor(queryly.resultdata.duration / 60);
                        var secs = Math.floor(queryly.resultdata.duration % 60);
                        if (minutes != 0 || secs != 0) {
                            if (secs < 10) {
                        ...
                        if (hours != 0) {
                            ...
                            queryly.resultdata.videoduration = hours + ":" + minutes + ":" + secs;
                        }
                    }

                    if (videoin >= 0 && queryly.resultdata.label.indexOf("Clip ") < 0) {
                        var starthours = Math.floor(videoin / 3600);
                        var startminutes = Math.floor(videoin / 60);
                        var startsecs = Math.floor(videoin % 60);
                        if (startsecs < 10) {
                        ...
                        if (starthours != 0) {
                            ...
                            if (typeof queryly.resultdata.videoduration == 'undefined') {
                                queryly.resultdata.videoduration = starthours + ":" + startminutes + ":" + startsecs;
                            }
                            else {
                                queryly.resultdata.videoduration = starthours + ":" + startminutes + ":" + startsecs + " | " + queryly.resultdata.videoduration;
                            }
                        }
                        else {
                            if (typeof queryly.resultdata.videoduration == 'undefined') {
                                queryly.resultdata.videoduration = startminutes + ":" + startsecs;
                            }
                            else {
                                queryly.resultdata.videoduration = startminutes + ":" + startsecs + " | " + queryly.resultdata.videoduration;
                            }
                        }
        ...
        getDateString: function (date) {
            ...
            try {
                ...
                if (diff < 5) {
                    ...
                    datestring = localtime.toLocaleDateString();
